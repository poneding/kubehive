...
import { Fragment, Suspense, lazy, useCallback, useDeferredValue, useEffect, useLayoutEffect, useMemo, useRef, useState, type KeyboardEvent as ReactKeyboardEvent, type MouseEvent as ReactMouseEvent, type ReactNode, type PointerEvent as ReactPointerEvent, type RefObject } from "react";
...
import "./platform.css";
import { contentFontSizes, createDefaultPreferences, groupLabel, resolveAppFont, resolveMonoFont, resourceLabel, t, SYSTEM_FONT, type AppLanguage, type ContentTheme, type Preferences } from "./preferences";
...
export default function App() {
  ...
  const [preferences, setPreferences] = useState<Preferences>(() => {
    try {
      const saved = JSON.parse(localStorage.getItem("kubehive.preferences") ?? "{}") as Partial<Preferences> & { language?: string; contentFont?: string };
