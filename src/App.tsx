  ...
  useEffect(() => {
    const handler = (event: KeyboardEvent) => {
      ...
      if (event.key === "Escape") {
        ...
        // While the session text search popover has focus, Escape belongs to it —
        // the popover closes itself and the dock stays put.
