...
const ui = {
  en: {
    ...
    actions: "Actions", connect: "Connect", openOverview: "Open overview", closeConnection: "Close connection", closingConnection: "Closing…", connected: "Connected", disconnected: "Disconnected", remove: "Remove",
  ...
  "zh-CN": {
    ...
    actions: "操作", connect: "连接", openOverview: "打开概览", closeConnection: "关闭连接", closingConnection: "正在关闭…", connected: "已连接", disconnected: "未连接", remove: "移除",
  ...
  "zh-TW": {
    ...
    actions: "操作", connect: "連線", openOverview: "開啟概覽", closeConnection: "關閉連線", closingConnection: "正在關閉…", connected: "已連線", disconnected: "未連線", remove: "移除",
