...
const ui = {
  en: {
    ...
    cancel: "Cancel", add: "Add cluster", allNamespaces: "All namespaces",
    ...
    resizeRail: "Resize cluster rail (double-click to reset)",
  ...
  "zh-CN": {
    ...
    cancel: "取消", add: "添加集群", allNamespaces: "所有命名空间",
  ...
  "zh-TW": {
    ...
    cancel: "取消", add: "新增叢集", allNamespaces: "所有命名空間",
