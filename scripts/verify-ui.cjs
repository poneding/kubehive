...
(async () => {
  ...
  await page.waitForFunction(() => document.querySelector(".session-action-bar .session-runtime-context")?.textContent?.includes("CONNECTED"));
