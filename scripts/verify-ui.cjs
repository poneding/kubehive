...
(async () => {
  ...
  const terminalContainerMenu = await page.locator(".container-target-combobox .combobox-popover").evaluate((popover) => {
    const trigger = popover.parentElement.querySelector(".combobox-trigger");
    return {
